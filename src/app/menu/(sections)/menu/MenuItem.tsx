  ...
  return (
    item && (
      <MenuItemPopup item={item}>
        <div className="z-10 flex h-[200px] w-full flex-row items-center overflow-hidden bg-[#fffdf0]/60">
          <div className="flex h-full w-[40%]">
            {item.images[0] ? (
              ...
              <div className="flex h-full w-full items-center justify-center bg-[#fffdf0]/60">
                <Image
          ...
          <div className="flex w-[60%] flex-col items-center justify-between gap-6 p-[2.5rem] md:flex-row">
            <div className="flex w-full flex-col gap-[1.62rem]">
              <h2 className="w-full text-[1.25rem] font-normal leading-[150%] text-black">
                {item.name}
              </h2>
              <p className="text-[1.35rem] font-medium leading-[80%] text-black">
                {
            ...
            <div className="flex w-full items-center justify-center">
              {cartItems.find(
                ...
                <Button
                  className={cn(
                    "bottom-2 w-fit rounded-none bg-white text-[1.25rem] font-medium leading-[80%] text-primary hover:bg-slate-100",
